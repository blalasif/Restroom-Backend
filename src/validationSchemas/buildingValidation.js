...
//         .required()
//         .messages({
//             'any.only': 'Building type must be one of Public, Private, Commercial, Industrial, or Mixed-Use',
...
//         }),
//     restrooms: Joi.string().required().messages({
//         'string.empty': 'Restrooms data is required',
//     }),
// });
